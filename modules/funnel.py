...
def reverse_calculate_targets(
    ...
    # 他社事例Q3累積成長率に基づく上限設定:
    # リーチ: 着実に伸びるが爆発しにくい（Q3: 3mo=1.7x, 6mo=2.9x, 12mo=8.6x → 控えめに設定）
    # PA: 伸びにくい指標（Q3: 中央値0%、施策なしでは横ばい → 最も控えめ）
    # クリック: 施策次第で大きく伸びる（Q3: 3mo=2.0x, 6mo=4.0x → 最も伸びしろ大）
    max_growth_reach = {"3ヶ月後": 1.3, "6ヶ月後": 1.7, "12ヶ月後": 2.5}.get(period, 1.7)
    max_growth_pa = {"3ヶ月後": 1.2, "6ヶ月後": 1.5, "12ヶ月後": 2.0}.get(period, 1.5)
